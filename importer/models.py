...
class AccountingGroup(models.Model):
    ...
    name = models.CharField(
        db_column="accountGroupName", blank=True, null=True, max_length=500
    )
...
class AccountType(models.Model):
    ...
    name = models.CharField(
        db_column="accountTypeName", blank=True, null=True, max_length=500
    )
    accounting_group = models.ForeignKey(
        AccountingGroup,
        on_delete=models.CASCADE,
        db_column="accountingGroupID",
        blank=True,
        null=True,
    )
...
class Account(models.Model):
    ...
    name = models.CharField(
        db_column="accountName", blank=True, null=True, max_length=500
    )
    ...
    currency = models.CharField(
        db_column="accountCurrency", blank=True, null=True, max_length=500
    )
    conversion_rate_new = models.FloatField(
        db_column="accountConversionRateNew", blank=True, null=True
    )
    currency_changed = models.IntegerField(
        db_column="currencyChanged", blank=True, null=True
    )
    ...
    credit_card_due_date = models.IntegerField(
        db_column="creditCardDueDate", blank=True, null=True
    )
    cash_based_accounts = models.IntegerField(
        db_column="cashBasedAccounts", blank=True, null=True
    )
    selector_visibility = models.IntegerField(
        db_column="accountSelectorVisibility", blank=True, null=True
    )
...
class CategoryGroup(models.Model):
    ...
    name = models.CharField(
        db_column="categoryGroupName", blank=True, null=True, max_length=500
    )
...
class ParentCategory(models.Model):
    ...
    name = models.CharField(
        db_column="parentCategoryName", blank=True, null=True, max_length=500
    )
    category_group = models.ForeignKey(
        CategoryGroup,
        on_delete=models.CASCADE,
        db_column="categoryGroupID",
        blank=True,
        null=True,
    )
    budget_amount = models.IntegerField(
        db_column="budgetAmountCategoryParent", blank=True, null=True
    )
    budget_period = models.IntegerField(
        db_column="budgetPeriodCategoryParent", blank=True, null=True
    )
    budget_enabled = models.IntegerField(
        db_column="budgetEnabledCategoryParent", blank=True, null=True
    )
    ...
    extra_column_string_1 = models.CharField(
        db_column="categoryParentExtraColumnString1",
        blank=True,
        null=True,
        max_length=500,
    )
    extra_column_string_2 = models.CharField(
        db_column="categoryParentExtraColumnString2",
        blank=True,
        null=True,
        max_length=500,
    )
...
class ChildCategory(models.Model):
    ...
    name = models.CharField(
        db_column="childCategoryName", blank=True, null=True, max_length=500
    )
    parent_category = models.ForeignKey(
        ParentCategory,
        on_delete=models.CASCADE,
        db_column="parentCategoryID",
        blank=True,
        null=True,
    )
...
class Filter(models.Model):
    ...
    name = models.CharField(
        db_column="filterName", blank=True, null=True, max_length=500
    )
    json_repr = models.CharField(
        db_column="filterJSON", blank=True, null=True, max_length=500
    )
...
class Item(models.Model):
    ...
    auto_fill_visibility = models.IntegerField(
        db_column="itemAutoFillVisibility", blank=True, null=True
    )
...
class TransactionType(models.Model):
    id = models.AutoField(
        db_column="transactionTypeTableID", primary_key=True, blank=True
    )
    name = models.CharField(
        db_column="transactionTypeName", blank=True, null=True, max_length=500
    )
...
class Transaction(models.Model):
    ...
    item = models.ForeignKey(
        Item, on_delete=models.CASCADE, db_column="itemID", blank=True, null=True
    )
    ...
    conversion_rate_new = models.FloatField(
        db_column="conversionRateNew", blank=True, null=True
    )
    ...
    account_reference = models.IntegerField(
        db_column="accountReference", blank=True, null=True
    )
    account_pair = models.ForeignKey(
        Account,
        on_delete=models.CASCADE,
        related_name="to+",
        db_column="accountPairID",
        blank=True,
        null=True,
    )
    uid_pair = models.ForeignKey(
        "self", on_delete=models.CASCADE, db_column="uidPairID", blank=True, null=True
    )
    deleted = models.IntegerField(db_column="deletedTransaction", blank=True, null=True)
    new_split = models.IntegerField(
        db_column="newSplitTransactionID", blank=True, null=True
    )
    transfer_group = models.IntegerField(
        db_column="transferGroupID", blank=True, null=True
    )
    ...
    reminder_group = models.IntegerField(
        db_column="reminderGroupID", blank=True, null=True
    )
    reminder_frequency = models.IntegerField(
        db_column="reminderFrequency", blank=True, null=True
    )
    reminder_repeat_every = models.IntegerField(
        db_column="reminderRepeatEvery", blank=True, null=True
    )
    reminder_ending_type = models.IntegerField(
        db_column="reminderEndingType", blank=True, null=True
    )
    reminder_start_date = models.DateTimeField(
        db_column="reminderStartDate", blank=True, null=True
    )
    reminder_end_date = models.DateTimeField(
        db_column="reminderEndDate", blank=True, null=True
    )
    ...
    reminder_repeating = models.IntegerField(
        db_column="reminderRepeating", blank=True, null=True
    )
    ...
    reminder_un_billed = models.IntegerField(
        db_column="reminderUnbilled", blank=True, null=True
    )
    credit_card_installment = models.IntegerField(
        db_column="creditCardInstallment", blank=True, null=True
    )
    reminder_version = models.IntegerField(
        db_column="reminderVersion", blank=True, null=True
    )
    ...
    def __str__(self):
        extra_text = (
            f" TO {self.account_pair}" if self.account != self.account_pair else ""
        )
...
class Label(models.Model):
    ...
    name = models.CharField(
        db_column="labelName", blank=True, null=True, max_length=500
    )
    transaction = models.ForeignKey(
        Transaction,
        on_delete=models.CASCADE,
        db_column="transactionIDLabels",
        blank=True,
        null=True,
    )
...
class Picture(models.Model):
    ...
    filename = models.CharField(
        db_column="pictureFileName", blank=True, null=True, max_length=500
    )
    transaction = models.ForeignKey(
        Transaction,
        on_delete=models.CASCADE,
